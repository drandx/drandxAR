//////////////////////////////////////////////////////////////
// JoystickSingle.js
// Single Joystick For Mobile Platforms
//
...
function Start()
{
	...
	var guiThumbAreaTransform : Transform = guiThumbArea.transform;
	...
	if(radiusThumbArea<=0){ //if no radius is specified, then thumb area width/2 is used for radius
		radiusThumbArea = (guiThumbAreaTransform.localScale.x * Screen.width)/2.0;
	}
	
	positionInitialThumbArea = new Vector2(guiThumbAreaTransform.position.x * Screen.width, guiThumbAreaTransform.position.y * Screen.height);
...
function showThumbFinger(touchPositionFinger : Vector2){
	...
	//var angelOfTouch : float = angelOfTouchArc * Mathf.Rad2Deg;
